...
//Specific to the article eV
   ...
   myPlot.addInstruction("set ylabel 'Y (au)'");
//Specific to the article 8
   ...
   myPlot.addInstruction("set multiplot  layout 3, 1");
...
asymptEnergy2<<"plot 'data.dat' index 2 using 3:2 w l ls 1 title '(c) tBirth=0.871, vPerpBirth=6E-5, asymptEnergy="<<asymptEnergy[2]<<" (au)'";
   ...
   myPlot.addInstruction("plot 'data.dat' index 0 using 3:2 w l ls 1 title '(a) errorMax=1E-10'");
   myPlot.addInstruction("plot 'data.dat' index 1 using 3:2 w l ls 1 title '(b) errorMax=1E-12'");
   myPlot.addInstruction("set xlabel 'Z (au)'");
   myPlot.addInstruction("plot 'data.dat' index 2 using 3:2 w l ls 1 title '(c) errorMax=1E-14''");

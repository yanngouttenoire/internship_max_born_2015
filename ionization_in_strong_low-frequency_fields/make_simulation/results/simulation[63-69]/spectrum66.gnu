...
set xrange [0:1]
set key on outside center bmargin Left reverse box title sprintf("nField = 100, nVYPerp = 1000, nVZPrimPerp = 100, charges = 0.4 0.2 0.2 0.2 , bondLength = -1 2 3 , \n weightThreshold = 0, weightTooSmallNbr = 0%, spectraPointNbr = 9575690, unexpectedStopNbr = 4.2%, binsWidth = 0.002, \n ErrorMax = 1e-10, dtMin = 1e-20, ellipticity = 0.1, fieldAmplMax = 0.0608629au, waveLenght = 1064nm, \n duration = 56 h 32 min 17 s , ")

...
set xrange [0:1]
set key on outside center bmargin Left reverse box title sprintf("nField = 100, nVYPerp = 1000, nVZPrimPerp = 100, charges = 0.4 0.2 0.2 0.2 , bondLength = 3 1 -2 , \n weightThreshold = 0, weightTooSmallNbr = 0%, spectraPointNbr = 9452235, unexpectedStopNbr = 5.4%, binsWidth = 0.002, \n ErrorMax = 1e-10, dtMin = 1e-20, ellipticity = 0.1, fieldAmplMax = 0.0608629au, waveLenght = 1064nm, \n duration = 58 h 33 min 24 s , ")

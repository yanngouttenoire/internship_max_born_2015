...
set xrange [0:1]
set key on outside center bmargin Left reverse box title sprintf("nField = 1000, nVYPerp = 1000, nVZPrimPerp = 1, charges = 0.4 0.2 0.2 0.2 , bondLength = 2 1 3 , \n weightThreshold = 0, weightTooSmallNbr = 0%, spectraPointNbr = 922203, unexpectedStopNbr = 7.7%, binsWidth = 0.005, \n ErrorMax = 1e-10, dtMin = 1e-20, ellipticity = 0.1, fieldAmplMax = 0.0608629au, waveLenght = 1064nm, \n duration = 4 h 54 min 17 s , ")

...
set xrange [0:1]
set key on outside center bmargin Left reverse box title sprintf("nField = 1000, nVYPerp = 1, nVZPrimPerp = 500, weightThreshold = 0, weightTooSmallNbr = 0%, \n spectraPointNbr = 472859, unexpectedStopNbr = 5.4%, binsWidth = 0.005, ErrorMax = 1e-10, dtMin = 1e-20, \n ellipticity = 0.2, fieldAmplMax = 0.0608629au, waveLenght = 1064nm, duration = 1 h 26 min 20 s , ")
